          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd :class="{active: attrValue.isChecked == 1}" v-for="attrValue in spuSaleAttr.spuSaleAttrValueList" :key="attrValue.id" @click="changeCheck(attrValue, spuSaleAttr.spuSaleAttrValueList)">{{attrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="changeSkuName">
