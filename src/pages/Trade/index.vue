        ...
        <div class="content">
            ...
            <div class="address clearFix" v-for="item in userAddressList" :key="item.id">
                ...
                <p @click="changeDefault(item, userAddressList)">
                    ...
                    <span class="s3" v-show="item.isDefault">默认地址</span>
                </p>
            </div>
            <div class="line"></div>
            ...
            <div class="bbs">
                <h5>买家留言：</h5>
                <textarea placeholder="建议留言前先与商家沟通确认" class="remarks-cont" v-model="cusMsg"></textarea>
            </div>
            <div class="line"></div>
            <div class="bill">
                <h5>发票信息：</h5>
...
export default {
    ...
    computed: {
        ...
        userDefaultAddress() {
            return this.userAddressList.find((val) => val.isDefault == 1) || {}
        }
    },
    methods: {
      changeDefault(userAddress, userAddressList) {
          for (let val of userAddressList) {
              val.isDefault = 0
          }
